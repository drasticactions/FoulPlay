...
namespace PlaystationApp
{
    public partial class App : Application
    {
        ...
        public static TrophyEntity.TrophyTitle SelectedTrophyTitle { get; set; }

        public static TrophyDetailEntity.Trophy SelectedTrophyDetail { get; set; }

        public static RecentActivityEntity SelectedRecentActivityEntity { get; set; }
